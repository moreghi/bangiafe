 ...
 getAuthHeader(): HttpHeaders   {
   ...
   const headers = new HttpHeaders(
    ...
    create(workFila: WorkFila){
      ...
      getCountPosti(idlog: number, idSettore: number):Observable<any> {
        this.rottafunction = '/getCountPosti/fileactive';
        return this.http.get(this.APIURL  + this.rottafunction + '/' + idlog + '/' + idSettore,  {
         headers: this.getAuthHeader()
        });      // ok
      }

      getCountPostiGlobal(idlog: number):Observable<any> {
        this.rottafunction = '/getCountPostiGlobal/fileactive';
