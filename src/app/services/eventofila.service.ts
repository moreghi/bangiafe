...
getbyevento(idEvento: number) {   // ok
  this.rottafunction = 'getbyEvento/evento';

console.log('EventoFilaService -- url: ' + this.APIURL + '/' + this.rottafunction +  '/' + idEvento )
...
getbyeventoSettoreStato(idEvento: number, idSettore: number, stato: number) {   // ok
  this.rottafunction = 'getAllFilebyevento/E/S/S';

console.log('EventoFilaService -- url: ' + this.APIURL + '/' + this.rottafunction +  '/' + idEvento + '/' + idSettore + '/' + stato )


  return this.http.get(this.APIURL + '/' + this.rottafunction +  '/'  + idEvento + '/' + idSettore + '/' + stato,  {
          headers: this.getAuthHeader()
        });      // ok;
}
