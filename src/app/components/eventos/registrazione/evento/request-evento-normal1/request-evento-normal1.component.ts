...
async registraWprenotaEvento(cognomeu: string, nomeu: string, emailu: string, telefonou: string) {
  ...
  this.wprenotazevento.idTipoBiglietto  =   this.selectedtipobiglietto;  //    this.tipobiglietto.idtipotaglia;
...
*/
  ...
  this.eventoPosto.tipobiglietto = this.selectedtipobiglietto;     //  this.idtipologiabiglietto;
