...
*/
    ...
    async loadEvento(id: number) {
                  ...
                  if(response['rc'] === 'ok') {
                    ...
                    this.gg = this.evento.data.substring(8,10);
                    this.mm = this.evento.data.substring(5,7);
                    this.aaaa = this.evento.data.substring(0,4);
                    console.log(' --------------  gg normalizzato: ' + this.gg)
                    console.log(' --------------  mm normalizzato: ' + this.mm)
console.log(' --------------  anno normalizzato: ' + this.aaaa)
                    this.dataeventoddmmyyyy =  this.gg + '/' + this.mm + '/' + this.aaaa;
                    console.log(' --------------  data normalizzata: ' + this.dataeventoddmmyyyy)

                     console.log('--------------------------  loadEvento:    dataeventoddmmyyyy ---- ' + this.dataeventoddmmyyyy)
...
//  attenzione   leggere da w_prenotaz
    ...
    async loadManifestazione(id: number) {
         ...
         async  prenota() {
                   // verifico se è la prima registrazione
                    ...
                    this.prenotazeventomasterConfirm.dataEvento = this.dataeventoddmmyyyy;
                    ...
                    this.prenotazeventomasterConfirm.localita = this.evento.localita;
                    this.prenotazeventomasterConfirm.indirizzo = this.evento.indirizzo;
